    ...
    <div class="container">
	   ...
	   <div class="page-header title">
		...
		<div class="form-layout">
	       <form:form   action="${pageContext.request.contextPath}/admin/product/updateProduct?${_csrf.parameterName_}=${_csrf.token_}"  method="post" commandName="product"    enctype="multipart/form-data" class="form-horizontal"  >
